...
public class 메소드공부4 {
	...
	public static int 일부터십까지합구하기() {
		//1~10까지 합을 구하는 로직을 구현후 합을 리턴하시오.
		int sum=0;
		for(int i=1;i<=10;i++) {
			sum = sum+i;
		}
	...
	/*
	 * 문제3)
	 * 1937년 Collatz란 사람에 의해 제기된 이 추측은, 주어진 수(n)가 1이 될때까지 다음 작업을 반복하면,
	...
	public static int solution(int n) {
		//1bit에 표현할수 있는 수가 8자리
		int answer = 0; //int 4byte(1byte ==8bit)
		long x=n; //long 8byte
		if(x==1) {
			return answer;
		}
